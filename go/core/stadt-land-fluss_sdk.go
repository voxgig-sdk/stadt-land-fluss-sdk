...
func (sdk *StadtLandFlussSDK) OptionsMap() map[string]any {
...
func (sdk *StadtLandFlussSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *StadtLandFlussSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *StadtLandFlussSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StadtLandFlussSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *StadtLandFlussSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *StadtLandFlussSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("StadtLandFlussSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *StadtLandFlussSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StadtLandFlussSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("StadtLandFlussSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *StadtLandFlussSDK {
	...
	sdk := NewStadtLandFlussSDK(sdkopts)
	sdk.Mode = "test"
