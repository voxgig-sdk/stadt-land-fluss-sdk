...
This is an unofficial SDK for the Stadt Land Fluss public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/stadt-land-fluss` | `npm install @voxgig-sdk/stadt-land-fluss` |
| Python | `voxgig-sdk-stadt-land-fluss` | `pip install voxgig-sdk-stadt-land-fluss` |
| PHP | `voxgig-sdk/stadt-land-fluss` | `composer require voxgig-sdk/stadt-land-fluss` |
| Golang | `github.com/voxgig-sdk/stadt-land-fluss-sdk/go` | `go get github.com/voxgig-sdk/stadt-land-fluss-sdk/go` |
| Ruby | `voxgig-sdk-stadt-land-fluss` | `gem install voxgig-sdk-stadt-land-fluss` |
| Lua | `voxgig-sdk-stadt-land-fluss` | `luarocks install voxgig-sdk-stadt-land-fluss` |
