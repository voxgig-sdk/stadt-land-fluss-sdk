...
Compact solution for Stadt Land Fluss (City Country River) game in German.

Learn more about Stadt Land Fluss at [github.com/slftool/slftool.github.io](https://github.com/slftool/slftool.github.io).
...
| --- | --- | --- |
| **Data** | The Data entity (list). | `/data.json` |
...
$datas = $client->Data()->list();
print_r(array_map(fn($item) => $item->data_get(), $datas));
```
