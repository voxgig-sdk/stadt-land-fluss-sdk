# StadtLandFluss SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions StadtLandFlussSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both StadtLandFlussSDK(...) and StadtLandFlussSDK.test(...) become
#      StadtLandFlussSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "stadtlandfluss_sdk"
_SDK_CLASS = "StadtLandFlussSDK"
