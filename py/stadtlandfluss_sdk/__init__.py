...
from stadtlandfluss_sdk.utility import register

# Load features
from stadtlandfluss_sdk.feature.base_feature import StadtLandFlussBaseFeature
from stadtlandfluss_sdk.features import _has_feature, _make_feature
...
class StadtLandFlussSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = StadtLandFlussUtility()
        self._utility = utility

        from stadtlandfluss_sdk.config import shared_config
    ...
    def get_utility(self):
        return StadtLandFlussUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("StadtLandFlussSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Data(self, data=None) -> "DataEntity":
        ...
        from stadtlandfluss_sdk.entity.data_entity import DataEntity
        return DataEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "StadtLandFlussSDK":
        if sdkopts is None:
            sdkopts = {}
