...
function envOverride(m) {
    if ('TRUE' === process.env.STADT_LAND_FLUSS_TEST_LIVE ||
        'TRUE' === process.env.STADT_LAND_FLUSS_TEST_OVERRIDE) {
    ...
    m.STADT_LAND_FLUSS_TEST_EXPLAIN = process.env.STADT_LAND_FLUSS_TEST_EXPLAIN || m.STADT_LAND_FLUSS_TEST_EXPLAIN;
    return m;
}
