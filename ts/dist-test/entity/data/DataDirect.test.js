...
(0, node_test_1.describe)('DataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.StadtLandFlussSDK({
...
function liveScenariosActive() { return false && process.env.STADT_LAND_FLUSS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.StadtLandFlussSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['STADT_LAND_FLUSS_TEST_DATA_ENTID'];
    ...
    const client = new __1.StadtLandFlussSDK({
        base: 'http://localhost:8080',
