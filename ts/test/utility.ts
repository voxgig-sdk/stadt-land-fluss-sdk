...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.STADTLANDFLUSS_TEST_LIVE ||
    'TRUE' === process.env.STADTLANDFLUSS_TEST_OVERRIDE
  ) {
  ...
  m.STADTLANDFLUSS_TEST_EXPLAIN = process.env.STADTLANDFLUSS_TEST_EXPLAIN || m.STADTLANDFLUSS_TEST_EXPLAIN
