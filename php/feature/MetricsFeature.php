...
// StadtLandFluss SDK metrics feature
...
class StadtLandFlussMetricsFeature extends StadtLandFlussBaseFeature
{
    ...
    private function _record(StadtLandFlussContext $ctx, bool $ok): void
    {
