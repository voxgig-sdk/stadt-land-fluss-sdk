...
// StadtLandFluss SDK rbac feature
...
class StadtLandFlussRbacFeature extends StadtLandFlussBaseFeature
{
    ...
    private function _required(StadtLandFlussContext $ctx): ?string
    {
    ...
    private function _reject(StadtLandFlussContext $ctx, string $required): void
    {
    ...
    private function _track(StadtLandFlussContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
