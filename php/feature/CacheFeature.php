...
// StadtLandFluss SDK cache feature
...
class StadtLandFlussCacheFeature extends StadtLandFlussBaseFeature
{
    ...
    private function _through(StadtLandFlussContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
