...
// StadtLandFluss SDK telemetry feature
...
class StadtLandFlussTelemetryFeature extends StadtLandFlussBaseFeature
{
    ...
    private function _close(StadtLandFlussContext $ctx, bool $ok): void
    {
