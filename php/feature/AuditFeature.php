...
// StadtLandFluss SDK audit feature
...
class StadtLandFlussAuditFeature extends StadtLandFlussBaseFeature
{
    ...
    private function _emit(StadtLandFlussContext $ctx, string $outcome): void
    {
