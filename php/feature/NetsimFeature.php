...
// StadtLandFluss SDK netsim feature
...
class StadtLandFlussNetsimFeature extends StadtLandFlussBaseFeature
{
    ...
    private function _simulate(StadtLandFlussContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(StadtLandFlussContext $ctx, array $applied): void
    {
        $client = $this->client;
