...
// StadtLandFluss SDK debug feature
...
class StadtLandFlussDebugFeature extends StadtLandFlussBaseFeature
{
    ...
    private function _finish(StadtLandFlussContext $ctx, bool $ok): void
    {
