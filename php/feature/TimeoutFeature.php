...
// StadtLandFluss SDK timeout feature
...
class StadtLandFlussTimeoutFeature extends StadtLandFlussBaseFeature
{
    ...
    private function _with_timeout(StadtLandFlussContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(StadtLandFlussContext $_ctx, float $ms): void
    {
        $client = $this->client;
