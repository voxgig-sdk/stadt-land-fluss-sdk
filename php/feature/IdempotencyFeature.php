...
// StadtLandFluss SDK idempotency feature
...
class StadtLandFlussIdempotencyFeature extends StadtLandFlussBaseFeature
{
    ...
    private function _mutating(StadtLandFlussContext $ctx): bool
    {
