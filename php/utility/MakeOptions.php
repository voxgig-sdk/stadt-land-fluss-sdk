...
// StadtLandFluss SDK utility: make_options

class StadtLandFlussMakeOptions
{
    ...
    public static function call(StadtLandFlussContext $ctx): array
    {
        ...
        //
        // `StadtLandFlussSchema::optspec()` is built from the model:
        ...
        $optspec = StadtLandFlussSchema::optspec();
