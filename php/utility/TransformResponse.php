...
// StadtLandFluss SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class StadtLandFlussTransformResponse
{
    public static function call(StadtLandFlussContext $ctx): mixed
    {
        ...
        $transform = StadtLandFlussHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
