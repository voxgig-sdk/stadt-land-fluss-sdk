...
// StadtLandFluss SDK utility: graphql
//
...
class StadtLandFlussGraphql
{
    ...
    // equivalent.
    public static function body(StadtLandFlussContext $ctx): mixed
    {
    ...
    public static function errors(StadtLandFlussContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
