# StadtLandFluss PHP SDK



The PHP SDK for the StadtLandFluss API — an entity-oriented client using PHP conventions.
...
print_r(array_map(fn($item) => $item->data_get(), $data));
```
...
```
php/
├── stadtlandfluss_sdk.php          -- Main SDK class
...
The main class (`stadtlandfluss_sdk.php`) exports the SDK class
