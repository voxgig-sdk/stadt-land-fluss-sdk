...
class StadtLandFlussTestRunner
{
    ...
    {
        $live = self::getenv('STADT_LAND_FLUSS_TEST_LIVE');
        $override = self::getenv('STADT_LAND_FLUSS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('STADT_LAND_FLUSS_TEST_EXPLAIN');
...
class_alias('StadtLandFlussTestRunner', 'Runner');
class_alias('StadtLandFlussHelpers', 'Helpers');
