...
// StadtLandFluss SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = StadtLandFlussOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(StadtLandFlussOmni::structfix($now, Struct::undef()))
                        !== json_encode(StadtLandFlussOmni::structfix($val, Struct::undef()))) {
