...
// StadtLandFluss SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (StadtLandFlussSDK::test)
...
{
    private const SDK_CLASS = 'StadtLandFlussSDK';
    ...
    private const SDK_BASE = 'stadtlandfluss_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../stadtlandfluss_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
