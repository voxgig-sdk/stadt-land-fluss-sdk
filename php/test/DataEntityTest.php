...
class DataEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set STADTLANDFLUSS_TEST_DATA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function data_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("STADTLANDFLUSS_TEST_DATA_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["STADTLANDFLUSS_TEST_DATA_ENTID"]);
