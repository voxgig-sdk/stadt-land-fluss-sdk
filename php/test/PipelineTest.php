...
// StadtLandFluss SDK pipeline test
//
...
{
    private static function utility(): StadtLandFlussUtility
    {
        return new StadtLandFlussUtility();
    }
    ...
    private static function ctx(array $over = []): StadtLandFlussContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new StadtLandFlussContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new StadtLandFlussOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof StadtLandFlussError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new StadtLandFlussOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = StadtLandFlussMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new StadtLandFlussOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = StadtLandFlussMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new StadtLandFlussOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = StadtLandFlussMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new StadtLandFlussSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = StadtLandFlussMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new StadtLandFlussResponse([]),
            'result' => new StadtLandFlussResult([]),
        ]);
        [, $err] = StadtLandFlussMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new StadtLandFlussSpec([]),
            'response' => null,
            'result' => new StadtLandFlussResult([]),
        ]);
        [, $err] = StadtLandFlussMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new StadtLandFlussSpec(['step' => 's']),
            'response' => new StadtLandFlussResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new StadtLandFlussResult([]),
        ]);
        [, $err] = StadtLandFlussMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new StadtLandFlussSpec(['step' => 's']),
            'response' => new StadtLandFlussResponse(self::resp(200, ['v' => 1])),
            'result' => new StadtLandFlussResult([]),
        ]);
        [, $err] = StadtLandFlussMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new StadtLandFlussSpec(['step' => 's']),
            'response' => new StadtLandFlussResponse(self::resp(200, ['v' => 2])),
            'result' => new StadtLandFlussResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        StadtLandFlussMakeResponse::call($ctx);
    ...
    {
        $preset = new StadtLandFlussResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new StadtLandFlussSpec([]),
            'response' => new StadtLandFlussResponse([]),
            'result' => new StadtLandFlussResult([]),
        ...
        [$got, $err] = StadtLandFlussMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new StadtLandFlussResult([])]);
        [, $err] = StadtLandFlussMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new StadtLandFlussSpec([]), 'result' => null]);
        [, $err] = StadtLandFlussMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new StadtLandFlussSpec(['step' => 's']),
            'result' => new StadtLandFlussResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new StadtLandFlussOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = StadtLandFlussMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new StadtLandFlussSpec(['step' => 's']),
            'result' => new StadtLandFlussResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new StadtLandFlussOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = StadtLandFlussMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new StadtLandFlussResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new StadtLandFlussSpec([]),
            'result' => new StadtLandFlussResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = StadtLandFlussMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = StadtLandFlussMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new StadtLandFlussError('boom', 'boom');
        $utility->fetcher = function (StadtLandFlussContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new StadtLandFlussSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = StadtLandFlussMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (StadtLandFlussContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = StadtLandFlussMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(StadtLandFlussResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        StadtLandFlussMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (StadtLandFlussContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new StadtLandFlussSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = StadtLandFlussMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new StadtLandFlussResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new StadtLandFlussSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = StadtLandFlussMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = StadtLandFlussMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = StadtLandFlussMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new StadtLandFlussResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, StadtLandFlussDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new StadtLandFlussResult(['ok' => false])]);
        $this->expectException(StadtLandFlussError::class);
        StadtLandFlussDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new StadtLandFlussResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', StadtLandFlussMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        StadtLandFlussMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new StadtLandFlussBaseFeature();
        $b = new StadtLandFlussBaseFeature();
        StadtLandFlussFeatureAdd::call($ctx, $a);
        StadtLandFlussFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): StadtLandFlussBaseFeature
    {
        $f = new StadtLandFlussBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        StadtLandFlussFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): StadtLandFlussContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new StadtLandFlussSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = StadtLandFlussPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        StadtLandFlussPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new StadtLandFlussResponse(['headers' => null]),
            'result' => new StadtLandFlussResult([]),
        ]);
        StadtLandFlussResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        StadtLandFlussResultBody::call($ctx);
