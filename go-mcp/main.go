// Command StadtLandFluss-mcp is an MCP server exposing the StadtLandFluss
// SDK as MCP tools.
//
// Two tools are registered:
//
//	StadtLandFluss_list  — list records of an entity
//	StadtLandFluss_load  — load a single record of an entity
//
