...
func registerTools(server *mcp.Server, client *sdk.StadtLandFlussSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "stadt-land-fluss_list",
		Description: "List records from StadtLandFluss. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "stadt-land-fluss_load",
		Description: "Load a single record from StadtLandFluss. " +
...
func runOp(client *sdk.StadtLandFlussSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.StadtLandFlussSDK, name string) (sdk.StadtLandFlussEntity, error) {
