...
func registerSDKWords(r *eng.Registry, client *sdk.StadtLandFlussSDK) {
...
func runOp(client *sdk.StadtLandFlussSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
