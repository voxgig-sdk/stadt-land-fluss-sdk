...
AQL-driven CLI and REPL for the StadtLandFluss SDK. Positional arguments are
...
```sh
go build -o stadt-land-fluss-cli ./...
```
...
./stadt-land-fluss-cli load 1 data
./stadt-land-fluss-cli load '{id:1}' data
