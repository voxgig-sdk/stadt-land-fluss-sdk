# StadtLandFluss SDK Data entity
...
class DataEntity
  ...
  def data_set(args)
    if args
      @_data = StadtLandFlussHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = StadtLandFlussHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Array<Data>, Array] the matching Data items; raises StadtLandFlussError on failure
