...
#      offline in seeded test mode (StadtLandFlussSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "StadtLandFluss_sdk.rb")
  SDK_CLASS = "StadtLandFlussSDK"
