...
class DataEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set STADTLANDFLUSS_TEST_DATA_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def data_basic_setup(extra)
  ...
  entid_env_raw = ENV["STADTLANDFLUSS_TEST_DATA_ENTID"]
