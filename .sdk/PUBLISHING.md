...
|---|---|---|
| `ts/` | @voxgig-sdk/stadt-land-fluss-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/stadt-land-fluss-sdk \
      --repository voxgig-sdk/stadt-land-fluss-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/stadt-land-fluss-sdk` shows it, and
`npm trust revoke @voxgig-sdk/stadt-land-fluss-sdk --id=<id>` removes it.
