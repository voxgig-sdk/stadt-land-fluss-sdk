...
// StadtLandFluss SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class StadtLandFlussMakeRequest
{
    public static function call(StadtLandFlussContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new StadtLandFlussResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new StadtLandFlussResponse($fetched);
        } else {
