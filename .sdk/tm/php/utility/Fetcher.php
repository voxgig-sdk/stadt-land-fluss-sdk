...
// StadtLandFluss SDK utility: fetcher

class StadtLandFlussFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; StadtLandFlussSDK/1.0)';
    ...
    public static function call(StadtLandFlussContext $ctx, string $fullurl, array $fetchdef): array
    {
