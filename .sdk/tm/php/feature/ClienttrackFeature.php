...
// StadtLandFluss SDK clienttrack feature
...
class StadtLandFlussClienttrackFeature extends StadtLandFlussBaseFeature
{
    ...
    public function PostConstruct(StadtLandFlussContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'StadtLandFluss-SDK';
