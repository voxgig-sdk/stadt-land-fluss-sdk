...
// StadtLandFluss SDK proxy feature
...
class StadtLandFlussProxyFeature extends StadtLandFlussBaseFeature
{
    ...
    public function init(StadtLandFlussContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (StadtLandFlussContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
