...
// StadtLandFluss SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class StadtLandFlussTestFeature extends StadtLandFlussBaseFeature
{
    ...
    public function init(StadtLandFlussContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (StadtLandFlussContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = StadtLandFlussParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (StadtLandFlussContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(StadtLandFlussContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = StadtLandFlussParam::call($ctx, $k);
