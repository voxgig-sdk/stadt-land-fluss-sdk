...
// StadtLandFluss SDK ratelimit feature
...
class StadtLandFlussRatelimitFeature extends StadtLandFlussBaseFeature
{
    ...
    private function _acquire(StadtLandFlussContext $ctx): void
    {
    ...
    private function _track(StadtLandFlussContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
