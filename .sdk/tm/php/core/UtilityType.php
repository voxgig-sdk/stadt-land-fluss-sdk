...
// StadtLandFluss SDK utility type

class StadtLandFlussUtility
{
    ...
    public static function copy(StadtLandFlussUtility $src): StadtLandFlussUtility
    {
        $u = new StadtLandFlussUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
