...
function runner.env_override(m)
  local live = runner.getenv("STADT_LAND_FLUSS_TEST_LIVE")
  local override = runner.getenv("STADT_LAND_FLUSS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("STADT_LAND_FLUSS_TEST_EXPLAIN")
