...
function runner.env_override(m)
  local live = runner.getenv("STADTLANDFLUSS_TEST_LIVE")
  local override = runner.getenv("STADTLANDFLUSS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("STADTLANDFLUSS_TEST_EXPLAIN")
